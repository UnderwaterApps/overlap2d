...
public class LabelAnchorListener extends AnchorListener {
    ...
    public LabelAnchorListener(NormalSelectionFollower follower, FollowerTransformationListener listenerResize,
            int anchorId) {
    ...
    public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
        ...
        if (follower.getMode() == NormalSelectionFollower.SelectionMode.transform) {
            if (listenerTransform != null)
                listenerTransform.anchorDown(follower, anchorId, event.getStageX(), event.getStageY());
        }
        return true;
    }
    ...
    public void touchDragged(InputEvent event, float x, float y, int pointer) {
        ...
        if (follower.getMode() == NormalSelectionFollower.SelectionMode.transform) {
            if (listenerTransform != null)
                listenerTransform.anchorDragged(follower, anchorId, event.getStageX(), event.getStageY());
        }
    }
    ...
    public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
        ...
        if (follower.getMode() == NormalSelectionFollower.SelectionMode.transform) {
            if (listenerTransform != null)
                listenerTransform.anchorUp(follower, anchorId, event.getStageX(), event.getStageY());
        }
    }
    ...
    public void enter(InputEvent event, float x, float y, int pointer, Actor fromActor) {
        ...
        if (follower.getMode() == NormalSelectionFollower.SelectionMode.transform) {
            if (listenerTransform != null)
                listenerTransform.anchorMouseEnter(follower, anchorId, event.getStageX(), event.getStageY());
        }
    }
    ...
    public void exit(InputEvent event, float x, float y, int pointer, Actor toActor) {
        ...
        if (follower.getMode() == NormalSelectionFollower.SelectionMode.transform) {
            if (listenerTransform != null)
                listenerTransform.anchorMouseExit(follower, anchorId, event.getStageX(), event.getStageY());
        }
    }
}
