...
public class EntityUtils {
    ...
    public static Array<Entity> getByLibraryLink(String link) {
        ...
        ImmutableArray<Entity> composites = Sandbox.getInstance()
                                                   .getEngine()
                                                   .getEntitiesFor(Family.all(NodeComponent.class).get());
    ...
    public static LayerItemVO getEntityLayer(Entity entity) {
        ...
        LayerMapComponent layerMapComponent = ComponentRetriever.get(
                entity.getComponent(ParentNodeComponent.class).parentEntity, LayerMapComponent.class);
