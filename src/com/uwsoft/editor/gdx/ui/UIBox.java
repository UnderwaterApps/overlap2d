...
public class UIBox extends Group {
    ...
    public void initPanel() {
        ...
        Image sideImgL = new Image(textureManager.getEditorAsset("boxSide"));
        Image sideImgR = new Image(textureManager.getEditorAsset("boxSide"));
        Image sideImgB = new Image(textureManager.getEditorAsset("boxSide"));
        Image cornerImgL = new Image(textureManager.getEditorAsset("boxCorner"));
        Image cornerImgR = new Image(textureManager.getEditorAsset("boxCorner"));

        topImg = new Image(textureManager.getEditorAsset(topImgName));
