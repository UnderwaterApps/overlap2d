...
public class EditingZone extends Actor {
            ...
            public void touchDragged(InputEvent event, float x, float y, int pointer) {
                if (selectedSplit >= 0) {
                    ...
                    if (selectedSplit == 2) { // top
                        splits[2] = -(int) ((y - shift.y - getHeight() / 2f) / currZoom - texture.getRegionHeight() /
                                2f);
                    ...
                    if (selectedSplit == 3) {
                        splits[3] = (int) ((y - shift.y - getHeight() / 2f) / currZoom + texture.getRegionHeight() /
                                2f);
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(texture, getX() + getWidth() / 2 - texture.getRegionWidth() / 2 + shift.x,
                ...
                texture.getRegionHeight() / 2f, texture.getRegionWidth(), texture.getRegionHeight(), currZoom, currZoom,
                0);
